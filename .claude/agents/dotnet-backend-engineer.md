...
- **AutoMapper** — mapping profiles organized per feature, avoiding leaky mappings
...
- EF Core 10.0.3, MediatR latest, FluentValidation 12.0.0, AutoMapper, Shouldly + xUnit + Moq for tests
